...
# MAGIC %sql
# MAGIC select * from telco_customer_churn_temp_view
...
display(telco_customer_casted_df)
...
telco_no_outliers_df.printSchema()
...
telmco_df =  telco_imputed_df.randomSplit([.8,.2], seed=42)
